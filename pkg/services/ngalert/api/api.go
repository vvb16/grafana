...
func (api *API) RegisterAPIEndpoints(m *metrics.API) {
	...
	api.RegisterRulerApiEndpoints(NewForkedRuler(
		...
		&RulerSrv{DatasourceCache: api.DatasourceCache, QuotaService: api.QuotaService, scheduleService: api.Schedule, store: api.RuleStore, log: logger, BaseInterval: api.Cfg.AlertingBaseInterval},
	), m)
